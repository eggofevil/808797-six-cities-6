...
const ReviewForm = ({handleSubmit, handleChange, evaluateForm}) => {
  return (
    <form className="reviews__form form" onSubmit={handleSubmit}>
      ...
      <textarea onChange={handleChange} className="reviews__textarea form__textarea" id="review" name="review" placeholder="Tell how was your stay, what you like and what can be improved" defaultValue={``} />
      <div className="reviews__button-wrapper">
        <p className="reviews__help">
          To submit review please make sure to set <span className="reviews__star">rating</span> and describe your stay with at least <b className="reviews__text-amount">50 characters</b>.
        </p>
        <button className="reviews__submit form__submit button" type="submit" disabled={evaluateForm()}>Submit</button>
      </div>
    </form>
  );
};
...
ReviewForm.propTypes = {
  ...
  evaluateForm: PropTypes.func.isRequired
};
